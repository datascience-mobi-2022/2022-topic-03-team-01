...
rnase.matrix=cbind(MS_Table[, seq(1,150,2)])
...
#rausfinden, wie oft ein protein in ctrl bzw. rnase schlecht korreliert
#as.data.frame(table(x)) creates a dataframe with frequence of repeating proteins 
#if a protein does not correlate well at least two times, it will be deleted (rows stored in rmv.lox.cor.ctrl/rnase)
#note that for ctrl and rnase the same proteins do not correlate well at least two times, still the process is conducted seperately 
#41 proteins will be deleted in cotrol and rnase
ctrl.low.cor=c()

...
datanormctrl1=datanormctrl1[-as.numeric(as.vector(rmv.low.cor)),] #we remove the low correlating proteins from the dataframes
...
peaks.ctrl = find_sig_peaks(mean.rep.ctrl, threshold = 3) #find_sig_peaks used on mean.rep.ctrl and rnase
...
color=c()
peaks.allg=cbind(peaks.ctrl.mtrx, peaks.rnase.mtrx,shift.mean)  #matrix that shows the peaks in control, in rnase and the shift between them

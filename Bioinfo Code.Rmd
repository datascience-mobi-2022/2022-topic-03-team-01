...
x=c(8,9,10)
y=c(1,2,3)
plot(gub[,1],gub[,2], col=gub$col)
col=c("green", "blue", "red")
gub=data.frame(x, y, col)
...
for (i in 1:nrow(peaks.mtrx)) {
 ...
 # pval <- append(pval, test$p.value)
  ...
  # alpha durch n teilen für korrektur?
  if (test$p.value < 0.05) {
    sigproteins <- append(sigproteins, rownames(peaks.allg)[1])
  } 
}
